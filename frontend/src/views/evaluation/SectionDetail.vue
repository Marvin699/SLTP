...
const AI_DEMO_DATA = {
  section1: [
    { group_id: '巡天组', scores: [95, 96, 88, 83, 95, 85] },   // 展示分: [95,96,78,73,95,85] 均分87 ✓第1
    { group_id: '凌云组', scores: [95, 95, 86, 82, 94, 84] },   // 展示分: [95,95,76,72,94,84] 均分86 ✓第2
    { group_id: '长空组', scores: [88, 90, 87, 84, 88, 87] },   // 展示分: [88,90,77,74,88,87] 均分84
    { group_id: '揽星组', scores: [86, 88, 85, 82, 86, 85] },   // 展示分: [86,88,75,72,86,85] 均分82
    { group_id: '御风组', scores: [80, 82, 73, 75, 80, 80] },   // 展示分: [80,82,63,65,80,80] 均分75
    { group_id: '逐日组', scores: [75, 78, 66, 68, 76, 77] },   // 展示分: [75,78,56,58,76,77] 均分70
  ],
  section2: [
...
const FALLBACK_SECTIONS = [
  { id: 'section1', name: '环节一：运输方案汇报与知识深化', short_name: '方案汇报', time_range: '0-10min', description: '小组汇报运输方案，教师/企业导师提问，AI词云与风险分析', dimensions: ['教师评分', '企业导师评分', 'Ai评分', '学生评分'], weights: { '教师评分': 0.35, '企业导师评分': 0.35, 'Ai评分': 0.15, '学生评分': 0.15 } },
  { id: 'section2', name: '环节二：应急推演与工单处置', short_name: '应急推演', time_range: '10-20min', description: '突发应急场景推演，各组提交工单三要素，AI生成综合质量分', dimensions: ['教师评分', '企业导师评分', 'Ai评分', '学生评分'], weights: { '教师评分': 0.35, '企业导师评分': 0.35, 'Ai评分': 0.15, '学生评分': 0.15 } },
  { id: 'section3', name: '环节三：飞行演练与裁判评分', short_name: '飞行演练', time_range: '21-36min', description: '限时飞行前检查、双电转单电操作、裁判六维能力评分', dimensions: ['教师评分', '企业导师评分', 'Ai评分', '学生评分'], weights: { '教师评分': 0.35, '企业导师评分': 0.35, 'Ai评分': 0.15, '学生评分': 0.15 } },
]
