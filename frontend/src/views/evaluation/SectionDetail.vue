...
// 注：创新性和经济性在六维画像展示时会自动减10分
const AI_DEMO_DATA = {
  section1: [
    { group_id: '逐日组', scores: [78, 80, 70, 74, 78, 80] },   // 展示分: [78,80,60,64,78,80] 均分73.3
    { group_id: '揽星组', scores: [93, 95, 88, 84, 93, 89] },   // 展示分: [93,95,78,74,93,89] 均分87 ✓第1
    { group_id: '驭风组', scores: [93, 95, 86, 82, 93, 89] },   // 展示分: [93,95,76,72,93,89] 均分86 ✓第2
    { group_id: '长空组', scores: [88, 90, 86, 86, 88, 90] },   // 展示分: [88,90,76,76,88,90] 均分84.7
    { group_id: '巡天组', scores: [86, 88, 84, 82, 86, 88] },   // 展示分: [86,88,74,72,86,88] 均分82.3
    { group_id: '凌云组', scores: [82, 84, 78, 76, 82, 84] },   // 展示分: [82,84,68,66,82,84] 均分77.7
  ],
  section2: [
...
function loadAIData() {
  ...
  const groups = demo.map((item) => {
    ...
    const avg = Math.round(total / AI_DIMENSIONS.length * 10) / 10
