...
const FALLBACK_SECTIONS = [
  ...
  { id: 'section2', name: '环节二：应急推演与工单处置', short_name: '应急推演', time_range: '10-20min', description: '突发应急场景推演，各组提交工单三要素，AI生成综合质量分', dimensions: ['决策速度', '方案可行性', '风险评估', '团队配合'], weights: { '决策速度': 0.35, '方案可行性': 0.35, '风险评估': 0.15, '团队配合': 0.15 } },
