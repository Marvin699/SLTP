...
const FALLBACK_SECTIONS = [
  ...
  { id: 'section3', name: '环节三：飞行演练与裁判评分', short_name: '飞行演练', time_range: '21-36min', description: '限时飞行前检查、双电转单电操作、裁判六维能力评分', dimensions: ['安全性', '操作规范性', '用时效率', '团队配合'], weights: { '安全性': 0.35, '操作规范性': 0.35, '用时效率': 0.15, '团队配合': 0.15 } },
]
